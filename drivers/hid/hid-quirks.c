...
#if IS_ENABLED(CONFIG_HID_APPLEIB)
	{ HID_USB_DEVICE(USB_VENDOR_ID_APPLE, USB_DEVICE_ID_APPLE_IBRIDGE), HID_QUIRK_FORCE_REPORT_SCAN },
#endif
#if IS_ENABLED(CONFIG_HID_APPLETB_KBD)
	{ HID_USB_DEVICE(USB_VENDOR_ID_APPLE, USB_DEVICE_ID_APPLE_TOUCHBAR_DISPLAY), HID_QUIRK_FORCE_REPORT_SCAN },
#endif
